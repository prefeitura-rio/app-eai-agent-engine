...
SHORT_MEMORY_TOKEN_LIMIT = int(getenv_or_action("SHORT_MEMORY_TOKEN_LIMIT", default="3000"))
SHORT_MEMORY_TIME_LIMIT = float(getenv_or_action("SHORT_MEMORY_TIME_LIMIT", default="0.00694")) # approx 10 minutes in days
