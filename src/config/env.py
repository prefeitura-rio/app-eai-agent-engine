...
SHORT_MEMORY_TOKEN_LIMIT = int(getenv_or_action("SHORT_MEMORY_TOKEN_LIMIT", default="10000"))
SHORT_MEMORY_TIME_LIMIT = int(getenv_or_action("SHORT_MEMORY_TIME_LIMIT", default="30"))
