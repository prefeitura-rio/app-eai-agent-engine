#!/usr/bin/env python3
"""
Test interativo para Service Agent - Foco UX
========================================

Este script permite testar o Service Agent de forma interativa,
...
class ServiceAgentTester:
    def __init__(self):
        print("\n🤖 Iniciando Service Agent...")
        self.agent = OrchestratedAgent(
            enable_service_agents=True,
            enable_workflows=False
        )
        print("✅ Service Agent inicializado com sucesso!")
        
    def run_interactive_test(self):
        """Executa teste interativo do Service Agent"""
        print(f"\n{'='*50}")
        print("🔵 TESTE INTERATIVO - SERVICE AGENT")
        print(f"{'='*50}")
        ...
        while True:
            try:
                ...
                if user_input.lower() in ['sair', 'exit', 'quit']:
                    print("\n👋 Encerrando teste do Service Agent...")
                    break
                    
                if not user_input:
                    continue
                
                print("\n🤖 Service Agent processando...")
