...
def _gate_cases() -> list[GateCase]:
    positives = [
        ...
        ("dark_on_street", "Esta escuro na rua"),
        ("dark_on_my_street", "Esta escuro na minha rua"),
        ("dark_on_our_street", "Ta escuro na nossa rua"),
        ("dark_here_on_street", "Esta escuro aqui na rua"),
        ("very_dark_on_avenue", "Ta muito escuro na avenida"),
        ("no_light_on_square", "Sem luz na praca"),
        ("no_lighting_on_sidewalk_inverted", "Sem iluminacao na calcada"),
        ("pitch_dark_on_bus_stop", "Esta no breu no ponto de onibus"),
        ("darkness_on_alley", "Esta na escuridao no beco"),
        ("no_clarity_on_street", "Sem claridade na rua"),
        ("poorly_lit_on_park", "Esta mal iluminado no parque"),
        ("dark_at_corner", "Ta escuro na esquina"),
        ("street_pitch_dark", "A rua esta no breu"),
        ("square_pitch_dark", "A praca ficou um breu"),
        ("avenue_no_clarity", "A avenida esta sem claridade"),
        ("alley_darkness", "O beco esta na escuridao"),
        ("sidewalk_no_visibility", "A calcada esta sem visibilidade de noite"),
        ...
        ("public_parking_light", "A luz do estacionamento publico apagou"),
        ...
        ("named_street_pitch_dark", "A Rua Dois esta no breu"),
        ("named_avenue_dark", "A Avenida Brasil ficou no escuro"),
        ("abbr_street_dark", "A R. das Flores esta escura"),
        ("abbr_street_no_light", "R. Dois esta sem luz"),
        ("abbr_avenue_dark", "A Av. Brasil esta escura"),
        ("abbr_square_dark", "A Pca. Sao Salvador esta escura"),
        ("abbr_square_accent_dark", "A Pça. XV esta sem iluminacao"),
        ("abbr_estrada_dark", "A Estr. do Galeao esta no breu"),
        ...
        ("bus_stop_darkness", "O ponto de onibus esta na escuridao"),
        ...
        ("lamp_in_front_of_num_abbr", "A lampada em frente ao num 33 queimou"),
        ("light_in_front_of_num_symbol", "A luz em frente ao nº 50 apagou"),
        ("lamp_in_front_of_num_degree", "A lampada em frente ao n° 120 queimou"),
        ("light_in_front_of_num_dot", "A luz em frente ao n. 80 apagou"),
        ("light_in_front_of_nro", "A luz em frente ao nro 50 apagou"),
        ("lamp_in_front_of_nr", "A lampada em frente ao nr 120 queimou"),
        ("light_in_front_of_plain_number", "A luz em frente ao 45 apagou"),
        ("lamp_near_num_symbol", "A lampada perto do nº 200 esta piscando"),
        ("light_close_to_number", "A luz proximo ao numero 50 apagou"),
        ("lamp_close_to_number_abbr", "A lampada proxima ao nr 120 queimou"),
        ("light_close_to_market", "A luz proximo ao mercado apagou"),
        ("lamp_close_to_school", "A lampada proxima da escola queimou"),
        ("light_at_number_height", "A luz na altura do numero 50 apagou"),
        ("lamp_at_market_height", "A lampada na altura do mercado queimou"),
        ("light_facing_number", "A luz defronte ao numero 50 apagou"),
        ("lamp_facing_church", "A lampada defronte da igreja queimou"),
        ("light_in_front_my_house", "Luz em frente minha casa apagou"),
        ("lamp_front_my_house", "Lampada frente minha casa queimada"),
        ("light_front_my_gate", "A luz frente meu portao apagou"),
        ("abbr_travessa_lamp", "A lampada da Tv. Alice queimou"),
        ...
        ("light_at_my_door", "A luz na porta da minha casa apagou"),
        ("lamp_at_school_door", "A lampada na porta da escola queimou"),
        ("light_next_to_church", "A luz ao lado da igreja esta piscando"),
        ("lamp_behind_market", "A lampada atras do mercado esta queimada"),
        ("light_beside_upa", "A luz do lado da UPA apagou"),
        ...
        ("square_parking_light", "A luz do estacionamento da praca apagou"),
        ("park_parking_fixture", "A luminaria do estacionamento do parque esta piscando"),
        ...
        ("post_light_low", "A luz do poste esta baixa"),
        ("street_lighting_low", "A iluminacao da rua esta baixa"),
        ("post_light_faltering", "A luz do poste esta fraquejando"),
        ("street_lamp_faltering", "A lampada da rua fica fraquejando"),
        ("post_light_failing", "A luz do poste esta falhando"),
        ("post_lamp_fails_often", "A lampada do poste falha toda hora"),
        ("street_light_fails_often", "A luz da rua falha toda hora"),
        ("post_lamp_no_ignition", "A lampada do poste esta sem acender"),
        ...
        ("street_lamp_problem", "A lampada da rua esta com problema"),
        ("street_fixture_stopped_working", "A luminaria da rua parou de funcionar"),
        ...
        ("sidewalk_post_crooked", "O poste da calcada esta torto"),
        ("fallen_post", "O poste caiu com fios expostos"),
        ("street_post_sparking", "O poste da rua esta faiscando"),
        ("post_short_happened", "O poste deu curto"),
        ("square_post_short_happened", "O poste da praca deu curto"),
        ("square_post_bare_short", "Curto no poste da praca"),
        ("street_fixture_bare_short", "Curto na luminaria da rua"),
        ("post_bare_short", "Tem curto no poste"),
        ("post_in_front_home_bare_short", "Curto no poste em frente minha casa"),
        ("post_light_sparking", "A luz do poste soltando faisca"),
        ...
        ("tree_and_lamp", "Preciso podar a arvore e a luminaria da rua apagou"),
        ("tree_branch_and_public_light", "Tem galho na arvore e a luz publica esta apagada"),
        ("traffic_light_and_street_lamp", "O semaforo esta ruim e a lampada do poste queimou"),
        ("internet_and_luminaria", "Meu cabo de internet caiu e a luminaria da rua esta apagada"),
        ("phone_wire_and_public_light", "O fio do telefone caiu e a luz da rua apagou"),
        ("tv_and_street_dark", "A tv a cabo esta fora e a rua esta escura"),
        ("tree_and_post_off", "Preciso podar uma arvore e o poste da rua apagou"),
        ...
        ("fixture_light_guess", "A luminaria da rua apagou e nao sei se e Light ou Rioluz"),
        ("public_light_light_guess", "A luz publica apagou, talvez seja Light"),
        ("post_off_light_guess", "O poste da rua apagou e o vizinho disse que e Light"),
        ("street_dark_light_guess", "A rua esta escura, nao sei se e Light ou Rioluz"),
        ("post_blinking_light_guess", "O poste esta piscando e falam que e Light"),
    ...
    negatives = [
        ...
        ("my_house_lamp_burned", "Lampada minha casa queimada"),
        ...
        ("living_room_light_low", "A luz da sala esta baixa"),
        ("bedroom_lamp_weak", "A lampada do quarto esta fraca"),
        ("bedroom_lamp_faltering", "A lampada do quarto esta falhando"),
        ("bedroom_lamp_fails_often", "A lampada do quarto falha toda hora"),
        ...
        ("tv_in_front_of_number", "A TV em frente ao numero 50 apagou"),
        ("room_lamp_in_front_of_number", "A lampada da sala em frente ao numero 50 queimou"),
        ("house_number_only", "Meu numero de casa e 50"),
        ...
        ("bedroom_pitch_dark", "Meu quarto esta no breu"),
        ("dark_living_room", "A sala ta escura"),
        ("living_room_darkness", "A sala esta na escuridao"),
        ("dark_home_stairs", "A escada da minha casa esta escura"),
        ("yard_no_visibility", "O quintal esta sem visibilidade de noite"),
        ("tv_no_clarity", "A imagem da TV esta sem claridade"),
        ("garage_no_lighting", "A garagem esta sem iluminacao"),
        ("garage_no_clarity", "A garagem esta sem claridade"),
        ("dark_in_room_inverted", "Esta escuro no quarto"),
        ("dark_in_my_room", "Esta escuro no meu quarto"),
        ("no_light_in_garage_inverted", "Sem luz na garagem"),
        ("no_lighting_in_room_inverted", "Sem iluminacao na sala"),
        ("pitch_dark_in_yard_inverted", "Esta no breu no quintal"),
        ("darkness_in_living_room_inverted", "Esta na escuridao na sala"),
        ("poorly_lit_in_kitchen_inverted", "Esta mal iluminado na cozinha"),
        ("negated_named_street_dark", "A Rua das Flores nao esta escura"),
        ("negated_abbr_avenue_dark", "A Av. Brasil nao esta escura"),
        ("negated_dark_on_street", "Nao esta escuro na rua"),
        ("negated_dark_on_my_street", "Nao esta escuro na minha rua"),
        ("negated_no_light_on_square", "Nao esta sem luz na praca"),
        ("negated_no_lighting_on_sidewalk", "Nao esta sem iluminacao na calcada"),
        ("negated_street_pitch_dark", "A rua nao esta no breu"),
        ("negated_square_no_clarity", "A praca nao esta sem claridade"),
        ("negated_avenue_darkness", "A avenida nao esta na escuridao"),
        ("negated_logradouro_dark", "O logradouro nao esta escuro"),
        ("post_light_color_question", "Qual a cor da luz do poste?"),
        ("post_light_color_statement", "A luz do poste e amarela"),
        ("street_light_annoyance", "A luz da rua incomoda meu quarto"),
        ("post_light_installation_info", "Quero saber quem colocou a luz do poste"),
        ("public_light_normal", "A luz publica esta funcionando normal"),
        ("post_light_not_off", "A luz do poste nao esta apagada"),
        ("post_lamp_not_burned", "A lampada do poste nao queimou"),
        ("post_has_light", "Tem luz no poste da rua"),
        ...
        ("light_grid_down", "A rede da Light caiu na rua"),
        ("light_meter_problem", "O medidor da Light esta com problema"),
        ("light_new_connection", "Preciso de ligacao nova da Light"),
        ("light_energy_wire", "Tem fio de energia da Light caido na rua"),
        ("light_energy_post_short", "O poste de energia da Light deu curto"),
        ...
        ("lamp_front_my_bed", "Lampada frente minha cama queimada"),
        ("light_close_to_bed", "A luz proxima da cama apagou"),
        ("lamp_close_to_mirror", "A lampada proxima do espelho queimou"),
        ("tv_close_to_number", "A TV proxima ao numero 50 apagou"),
        ("light_at_room_height", "A luz na altura da sala apagou"),
        ("bed_light_off", "A luz perto da cama apagou"),
        ("corner_negated_dark", "A esquina nao esta escura"),
        ("street_post_low", "O poste da rua e baixo"),
        ...
        ("gate_post_fell", "O poste do meu portao caiu"),
        ("gate_post_crooked", "O poste do nosso portao esta torto"),
        ("possessive_fence_post", "O poste da minha cerca esta bambo"),
        ...
        ("house_door_light", "A luz da porta da minha casa apagou"),
        ("school_door_lamp", "A lampada da porta da escola queimou"),
        ("church_side_light", "A luz lateral da igreja esta piscando"),
        ("market_back_lamp", "A lampada dos fundos do mercado queimou"),
        ...
        ("market_parking_luminaria", "A luminaria do estacionamento do mercado apagou"),
        ("restaurant_parking_luminaria", "A luminaria do estacionamento do restaurante esta piscando"),
        ("clinic_parking_luminaria", "A luminaria do estacionamento da clinica esta fraca"),
        ...
        ("home_outlet_short_happened", "A tomada da sala deu curto"),
        ("home_outlet_bare_short", "Curto na tomada da sala"),
        ("home_shower_bare_short", "Curto no chuveiro"),
        ("store_extension_bare_short", "Curto na extensao da loja"),
        ("building_energy_panel_bare_short", "Curto no quadro de energia do predio"),
        ("building_energy_panel_short", "O quadro de energia do predio esta com curto"),
        ("home_shower_sparking", "Meu chuveiro esta faiscando"),
        ("store_extension_short", "A extensao da loja deu curto"),
