...
_LUMINARIA_PUBLIC_PLACE_PATTERN = (
    ...
    r"estacionamentos?\s+p[uú]blicos?|"
...
_LUMINARIA_ASSET_CONTEXT_RE = re.compile(
    ...
    rf"baixas?|fraquejando|falha(?:ndo)?|sem\s+acender|"
...
_LUMINARIA_DEFECT_CONTEXT_RE = re.compile(
    ...
    r"baixas?|fraquejando|falha(?:ndo)?|sem\s+acender|"
...
_LUMINARIA_SERVICE_INTENT_CONTEXT_RE = re.compile(
    ...
    r"(?:reparo|conserto|manuten[cç][aã]o|chamado|troca|substitui[cç][aã]o)|"
    r"(?:reparo|conserto|manuten[cç][aã]o|chamado)\s+"
    r"(?:(?:da|do|de|na|no)\s+)?"
    r"(?:luz|lumin[aá]rias?|l[aâ]mpadas?|ilumina[cç][aã]o|postes?)|"
    r"(?:consertar|arrumar)\s+(?:a\s+|o\s+|as\s+|os\s+)?"
    r"(?:luz|lumin[aá]rias?|l[aâ]mpadas?|ilumina[cç][aã]o|postes?)|"
    r"troca|trocar|substitui(?:r|[cç][aã]o)|repor|reposi[cç][aã]o|"
...
_LUMINARIA_PROXIMITY_CONTEXT_RE = re.compile(
    ...
    r"(?:n[uú]mero|num(?:ero)?|nro|nr|n[º°.]?|\d+)|"
    ...
    r"pr[oó]xim[ao]\s+(?:a|ao|[àa]|da|do|de)\s+(?:minha\s+)?(?:casa|"
    r"(?:n[uú]mero|num(?:ero)?|nro|nr|n[º°.]?|\d+)|"
    r"mercado|bar|loja|com[eé]rcio|restaurante|igreja|farm[aá]cia|"
    r"padaria|creche|upa|escola|hospital|posto|cl[ií]nica|"
    r"pr[eé]dio|condom[ií]nio)|"
    r"na\s+altura\s+(?:da|do|de)\s+(?:minha\s+)?(?:casa|"
    r"(?:n[uú]mero|num(?:ero)?|nro|nr|n[º°.]?|\d+)|"
    r"mercado|bar|loja|com[eé]rcio|restaurante|igreja|farm[aá]cia|"
    r"padaria|creche|upa|escola|hospital|posto|cl[ií]nica|"
    r"pr[eé]dio|condom[ií]nio)|"
    r"defronte\s+(?:a|ao|[àa]|da|do|de)\s+(?:minha\s+)?(?:casa|"
    r"(?:n[uú]mero|num(?:ero)?|nro|nr|n[º°.]?|\d+)|"
    r"mercado|bar|loja|com[eé]rcio|restaurante|igreja|farm[aá]cia|"
    r"padaria|creche|upa|escola|hospital|posto|cl[ií]nica|"
    r"pr[eé]dio|condom[ií]nio)|"
    r"na\s+(?:frente|porta)\s+(?:da|do|de)\s+(?:minha\s+)?(?:casa|"
    r"mercado|bar|loja|com[eé]rcio|restaurante|igreja|farm[aá]cia|"
    r"padaria|creche|upa|escola|hospital|posto|cl[ií]nica|"
    r"pr[eé]dio|condom[ií]nio)|"
    r"(?:ao|do)\s+lado\s+(?:da|do|de)\s+(?:mercado|bar|loja|"
    r"com[eé]rcio|restaurante|igreja|farm[aá]cia|padaria|creche|upa|"
    r"escola|hospital|posto|cl[ií]nica|pr[eé]dio|condom[ií]nio)|"
    r"atr[aá]s\s+(?:da|do|de)\s+(?:mercado|bar|loja|com[eé]rcio|"
    r"restaurante|igreja|farm[aá]cia|padaria|creche|upa|escola|"
    r"hospital|posto|cl[ií]nica|pr[eé]dio|condom[ií]nio)|"
    r"perto\s+(?:da|do|de)\s+(?:minha\s+)?(?:casa|"
    r"(?:n[uú]mero|num(?:ero)?|nro|nr|n[º°.]?|\d+)|mercado|bar|loja|"
    r"com[eé]rcio|restaurante|igreja|farm[aá]cia|padaria|creche|upa|"
    r"escola|hospital|posto|cl[ií]nica|pr[eé]dio|condom[ií]nio)"
    r")\b"
)
...
_NON_LUMINARIA_PRIVATE_ASSET_RE = re.compile(
    ...
    r"estacionamentos?\s+(?:da|do|de)\s+"
    r"(?:lojas?|mercados?|bares?|restaurantes?|farm[aá]cias?|padarias?|"
    r"igrejas?|creches?|upas?|shoppings?|cl[ií]nicas?|pr[eé]dios?)|"
    r"salas?(?:\s+de\s+aula)?|quartos?|cozinhas?|banheiros?|"
